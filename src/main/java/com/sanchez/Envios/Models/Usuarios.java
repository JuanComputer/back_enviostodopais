...
public class Usuarios {
    ...
    @Column(name = "tb_usuarios_name", nullable = false)
    private String nombre;

    @Column(name = "tb_usuarios_apellido_paterno", nullable = false)
    private String apellidoP;

    @Column(name = "tb_usuarios_apellido_materno", nullable = false)
    ...
    // Sede asignada (para Operadores y Administradores de Sede)
    @ManyToOne
    @JoinColumn(name = "tb_tiendas_id")
    private Tiendas sede;
